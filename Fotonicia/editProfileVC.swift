...
class editProfileVC: UIViewController, UIScrollViewDelegate {
...
//        setupsignUpButton()
//        
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Update", style: .done, target: self, action: #selector(signupaction))
    ...
    func setupprofileImage(){
        viewOnScroll.addSubview(profileImage)
        profileImage.centerXAnchor.constraint(equalTo: viewOnScroll.centerXAnchor).isActive = true
        profileImage.topAnchor.constraint(equalTo: viewOnScroll.topAnchor, constant: 85).isActive = true
        profileImage.widthAnchor.constraint(equalTo: viewOnScroll.widthAnchor).isActive = true
    ...
    func setupfirstnameBox() {
        ...
        firstnameBox.topAnchor.constraint(equalTo: profileImage.bottomAnchor,constant: 10).isActive = true
    ...
    lazy var signUpButton:UIButton = {
        ...
        readBtn.setTitle("Submit", for: .normal)
        ...
        readBtn.addTarget(self, action: #selector(signupaction), for: .touchUpInside)
