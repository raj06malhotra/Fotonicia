...
class offersVc:  UICollectionViewController,UICollectionViewDelegateFlowLayout {
    
    
    
    var array = [offer_details]()
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(offersCell.self, forCellWithReuseIdentifier: "cell")
